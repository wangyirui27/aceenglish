...
| 酒吧/酒红色/酒馆/俱乐部 | 琴房/排练室/练习室/音乐学院；深红色/暗红色 |
| 烟/抽烟/香烟 | （尽量不出现） |
| 醉/喝醉 | （直接删除） |
| 纹身 | 图案/几何装饰/花纹 |
| 低胸/性感/暴露 | （直接删除或换成风格描写） |
| negative prompt里的种族/民族词 | 只用技术类阻断词 |

另外：尽量不出现酒精、烟（如果用户特别喜欢某个抽烟细节可以保留但需标注；默认不抽烟）、特写不要有宗教具体符号、不要品牌名、不要真实名人肖像。**中文提示词里"酒"字是审核高危字，任何含"酒"的词都必须替换。**
...
15秒写实电影感{情绪}短剧，{场景一句话描术}，{地点细节}，16:9横屏，ARRI Alexa质感，35mm胶片颗粒感，{光源物理描写}，{色板}，浅景深，PBR材质，真实皮肤质感，{皮肤细节}，毛孔清晰可见，摄影写实风格，非CG，非动漫，非卡通。
